...
import type { DBPaymentMethod } from "./useCheckoutDialog";
...
interface CheckoutPaymentSectionProps {
  ...
  effectiveDownPaymentPctLabel: string | null;
  ...
  return (
    <>
      ...
      <div>
        ...
        {minimumRequired < total && allocatedTotal < minimumRequired - 0.01 && allocatedTotal > 0 && (
          <div className="text-xs mt-1 px-2.5 text-red-600 dark:text-red-400">
            Min. down payment: {formatCurrency(minimumRequired)}{effectiveDownPaymentPctLabel ? ` (${effectiveDownPaymentPctLabel})` : ''} — need {formatCurrency(minimumRequired - allocatedTotal)} more
          </div>
        )}
      </div>
    </>
